...
class DeviceServiceImpl(device_pb2_grpc.DeviceServiceServicer):
    """
    Implementa os métodos do serviço gRPC definidos no arquivo .proto,
    permitindo que o Gateway chame remotamente as funções deste dispositivo.
    """
    def SetStatus(self, request, context):
        """
        Altera o estado do dispositivo (ON/OFF) conforme solicitado pelo Gateway.
        Após alterar o estado interno, publica a atualização no tópico de dados.
        """
        global device_state
