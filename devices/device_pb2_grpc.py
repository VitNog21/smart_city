...
import gateway.device_pb2 as device__pb2
...
class DeviceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetStatus = channel.unary_unary(
                '/device.DeviceService/SetStatus',
                request_serializer=device__pb2.CommandRequest.SerializeToString,
                response_deserializer=device__pb2.StatusResponse.FromString,
                _registered_method=True)
        self.SetConfig = channel.unary_unary(
                '/device.DeviceService/SetConfig',
...
def add_DeviceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SetStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=device__pb2.StatusResponse.SerializeToString,
            ),
...
class DeviceService(object):
    ...
    def SetStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            device__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
